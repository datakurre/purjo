...
|----------|-----------|-------------|
| Use external task pattern | Enables distributed execution, fault tolerance | ADR-0002 |
| Use `uv` for environment management | Fast, reproducible, supports offline mode | ADR-0001 |
...
- **ADR-0001**: Use of uv for environment management
- **ADR-0002**: Use of external task pattern
